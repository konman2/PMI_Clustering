...
for i in range(len(nz[0])):
    ...
    Pnc[v][u] = np.log(Pi[v-1]*P[v-1,u-1]) - np.log(Pi[v-1]*Pi[u-1])
    Pnc [v][v] = np.log(Pi[v-1]*P[v-1,v-1]) - np.log(Pi[v-1]*Pi[u-1])
    Pnc[u][u] = np.log(Pi[u-1]*P[u-1,u-1]) - np.log(Pi[u-1]*Pi[v-1])
    Pnc[u][v] = np.log(Pi[u-1]*P[u-1,v-1]) - np.log(Pi[u-1]*Pi[v-1])
    Pcn[v][u] = np.log(Pi[v-1]*P[v-1,u-1]) - np.log(Pi[v-1]*Pi[u-1])
    Pcn [v][v] = np.log(Pi[v-1]*P[v-1,v-1]) - np.log(Pi[v-1]*Pi[u-1])
    Pcn[u][u] = np.log(Pi[u-1]*P[u-1,u-1]) - np.log(Pi[u-1]*Pi[v-1])
    Pcn[u][v] = np.log(Pi[u-1]*P[u-1,v-1]) - np.log(Pi[u-1]*Pi[v-1])
    Pnn[v][u] = np.log(Pi[v-1]*P[v-1,u-1]) - np.log(Pi[v-1]*Pi[u-1])
    Pnn[v][v] = np.log(Pi[v-1]*P[v-1,v-1]) - np.log(Pi[v-1]*Pi[u-1])
    Pnn[u][u] = np.log(Pi[u-1]*P[u-1,u-1]) - np.log(Pi[u-1]*Pi[v-1])
    Pnn[u][v] = np.log(Pi[u-1]*P[u-1,v-1]) - np.log(Pi[u-1]*Pi[v-1])
    Pcc[v][u] = np.log(Pi[v-1]*P[v-1,u-1]) - np.log(Pi[v-1]*Pi[u-1])
    Pcc [v][v] = np.log(Pi[v-1]*P[v-1,v-1]) - np.log(Pi[v-1]*Pi[u-1])
    Pcc[u][u] = np.log(Pi[u-1]*P[u-1,u-1]) - np.log(Pi[u-1]*Pi[v-1])
    Pcc[u][v] = np.log(Pi[u-1]*P[u-1,v-1]) - np.log(Pi[u-1]*Pi[v-1])
