% Generate stability for a weighted graph.
% Input: 
...
if ~exist('filepath', 'var')
    filepath = '/Users/zexi/Codes/PyCharmProjects/MarkovStability/graphs/snp500w/';
end
if ~exist('time', 'var')
    time = 10.^[-5:0.1:5];
end
...
writetable(table_full,[filepath,'stability_101.csv'],'Delimiter',' ','WriteVariableNames',false);
